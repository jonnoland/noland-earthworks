...
describe("Noland Field dark brand theme", () => {
  ...
  it("keeps the dark-theme companion package version aligned for the published v0.4.14 release", () => {
    ...
    expect(androidBuild).toContain('versionName "0.4.14"');
    expect(androidBuild).toContain("versionCode 16");
  });
});
