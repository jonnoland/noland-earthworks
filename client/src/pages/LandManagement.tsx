...
const data: ServicePageProps = {
  ...
  overviewBody: [
    ...
    "Noland Earthworks uses a tracked forestry mulcher as the primary tool for suitable vegetation work. It processes heavy brush, saplings, and small timber into mulch that remains on the ground as cover. Site conditions determine the final method and result.",
    "Every job starts with a walk of the property. We assess terrain, vegetation density, access points, slopes, wet areas, structures, fencing, and utilities before preparing a written proposal. Noland Earthworks is veteran-owned and operated.",
  ],
  benefits: [
    ...
    "Mulch remains on-site as ground cover for suitable forestry-mulching projects",
    "Residential acreage, agricultural land, pasture reclamation, and access improvement",
  ...
  faqs: [
    {
      ...
      answer: "Timeline depends on vegetation density, terrain, access, weather, and the written scope. A site visit is the right way to confirm a realistic work plan.",
    },
    {
      question: "What happens to the trees and debris?",
      answer: "For suitable forestry-mulching projects, vegetation is processed into mulch that remains on the property as ground cover. Debris hauling is not part of Noland Earthworks' service scope.",
    },
    {
      question: "Do you handle stump removal?",
      answer: "Stump treatment is discussed during the site visit. Grading, excavation, and construction preparation are not part of Noland Earthworks' service scope.",
    },
    {
    ...
    },
    {
      ...
      answer: "Work near waterways or wetlands may require additional permits. The property owner should confirm requirements with the appropriate authority before work begins.",
    },
    {
...
export default function LandManagementPage() {
  usePageTitle(
    ...
    "Veteran-owned land management across Middle and West Tennessee. Forestry mulching, pasture reclamation, and fence line work are evaluated through a site visit and written proposal.",
