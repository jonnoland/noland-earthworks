...
export default function SitePreparationBeforeBuilding() {
  return (
    <BlogPostLayout
      ...
      metaDescription="Planning to build on Tennessee land? Learn the 5 site prep steps every landowner needs before construction starts — from clearing and grubbing to grading and."
      date="April 2026"
      dateISO="2026-04-09"
    ...
    >
      <p>
        You've found the land. Maybe you've already closed on it. Now comes the question that every new Tennessee landowner eventually asks: <strong>What do I need to do before I can build?</strong> Site preparation is the critical bridge between raw land and a buildable lot — and skipping steps here can cost you far more than doing it right the first time.
      </p>
      <p>
      ...
      <h2>Step 1: Survey and Stake Your Property</h2>
      <p>
      ...
      <h2>Step 3: Grubbing and Stump Removal</h2>
      <p>
        Clearing removes above-ground vegetation, but <strong>grubbing</strong> addresses what's underground — root systems, buried stumps, and organic debris. Any organic material left in the soil beneath a foundation will decompose over time, causing settlement and structural problems.
      </p>
      <p>
      ...
      <h2>Step 5: Erosion and Sediment Control</h2>
      <p>
      ...
      <h2>What Comes After Site Prep?</h2>
      <p>
