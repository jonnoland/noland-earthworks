...
export default function LandClearingRutherfordCounty() {
  return (
    <BlogPostLayout
      ...
      pageTitle="Land Clearing in Rutherford County, TN | Noland Earthworks"
      metaDescription="Need land clearing in Rutherford County, TN? Noland Earthworks provides forestry mulching and land clearing in Murfreesboro, Smyrna, La Vergne, Eagleville, and across Rutherford County."
      date="April 2026"
      dateISO="2026-04-12"
    ...
    >
      ...
      <h2>Common Land Clearing Projects We Handle in Rutherford County</h2>
      <p>
