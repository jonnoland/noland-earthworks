...
export default function LandClearingDavidsonCounty() {
  return (
    ...
    >
      ...
      <ul>
        <li>
          <strong>Infill lot clearing</strong> — Nashville's infill development boom has created strong demand for clearing overgrown urban and suburban lots. Many of these properties have been vacant for years and are covered in dense brush, volunteer trees, and invasive species. We clear them efficiently and leave a clean, level surface ready for a builder.
        </li>
        <li>
          <strong>Acreage reclamation</strong> — Larger properties in the rural eastern and western portions of Davidson County — particularly around Joelton, Whites Creek, and the areas near the county line — often have significant cedar encroachment and brushy overgrowth that has reduced usable acreage over time. Forestry mulching is the most cost-effective way to reclaim this land.
        </li>
        <li>
          <strong>Fence line and property boundary clearing</strong> — Overgrown fence lines are a persistent problem on Davidson County properties that border agricultural or wooded land. Clearing them restores property boundaries and reduces the pressure that vine and tree growth puts on fence posts and wire.
        </li>
        <li>
          <strong>Pre-construction site preparation</strong> — Before a foundation is poured, a septic system installed, or a driveway cut, the land must be cleared to the specifications required by your builder or engineer. We prepare sites across Davidson County to those standards, working around existing trees you want to preserve whenever possible.
        </li>
        <li>
          <strong>Invasive species removal</strong> — Privet, autumn olive, multiflora rose, and Chinese wisteria are widespread across Davidson County and can overtake a property in just a few growing seasons. Forestry mulching removes these species at scale and, when combined with appropriate follow-up treatment, prevents rapid regrowth.
        </li>
        <li>
          <strong>Storm damage cleanup</strong> — Middle Tennessee's severe weather season can leave properties covered in downed trees and debris. We handle storm cleanup efficiently, clearing fallen timber and damaged vegetation so you can assess and repair your property.
        </li>
      </ul>
