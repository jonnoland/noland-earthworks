...
export default function CostOfLandClearing() {
  return (
    ...
    >
      ...
      <p>
        Forestry mulching, on the other hand, is a single-step process. A specialized machine grinds trees, brush, and stumps into mulch right where they stand. Because it only requires one machine and one operator, and eliminates hauling and burning costs, forestry mulching is generally much more cost-effective — often ranging from <strong>$1,500 to $2,500 per acre</strong>.
      </p>

      <h2>Factors That Affect Your Quote</h2>
      <ol>
        <li>
          <strong>Vegetation Density</strong> — A field of light brush takes less time to clear than a dense forest of mature hardwoods.
        </li>
        <li>
          <strong>Terrain and Slope</strong> — Steep inclines or rocky terrain require slower, more careful operation.
        </li>
        <li>
          <strong>Acreage</strong> — The cost per acre often decreases on larger jobs due to economies of scale.
        </li>
        <li>
          <strong>End Goal</strong> — The required finish dictates the level of detail and time required. A rough pasture clearing differs from a manicured lot ready for construction.
        </li>
      </ol>

      <h2>Long-Term Value of Forestry Mulching</h2>
      <p>
