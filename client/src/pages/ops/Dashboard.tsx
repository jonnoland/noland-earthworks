...
const recentJobs = [
  { id: "1042", client: "Smith Ranch", location: "Bastrop, TX", acres: 14.5, value: 8700, status: "active", crew: "Crew A" },
  { id: "1041", client: "Henderson Property", location: "Buda, TX", acres: 8.2, value: 4920, status: "complete", crew: "Crew B" },
  { id: "1040", client: "Lone Star Farms", location: "Kyle, TX", acres: 22.0, value: 13200, status: "scheduled", crew: "Crew A" },
  { id: "1039", client: "Davis Homestead", location: "Wimberley, TX", acres: 5.5, value: 3300, status: "complete", crew: "Crew C" },
  { id: "1038", client: "Pinecrest Development", location: "San Marcos, TX", acres: 35.0, value: 21000, status: "invoiced", crew: "Crew B" },
];
      ...
      <div className="p-6 space-y-6">
        ...
        >
          <div className="px-6 py-5 flex items-center justify-between">
            <div>
              <p className="text-xs font-semibold uppercase tracking-widest text-primary mb-1">Good morning, Jake</p>
              ...
              <p className="text-sm text-muted-foreground mt-1">April target: $75,000 — currently at 91% pace</p>
            </div>
          ...
          <div className="ops-card overflow-hidden">
            <div className="p-4 border-b border-border flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-muted-foreground">Central Texas operations</p>
              </div>
              <button
