  ...
  return (
    <div className="space-y-4">
      ...
      <SettingsSection
        ...
        description="Connect Google and Facebook to pull live customer reviews into the Reviews dashboard."
      >
        <div className="space-y-4">
          ...
          <div className="border border-border rounded-lg p-4 space-y-2.5">
            ...
            <div className="text-[11px] text-muted-foreground space-y-1 pl-[2.75rem]">
              <p>Reviews are fetched live from your Google Business Profile and displayed on the Reviews page. Requires the Google Business Profile connection above.</p>
              <p className="text-amber-400/80">To enable: connect Google Business Profile in the section above. Once connected, reviews will appear automatically in <a href="/ops/reviews" className="underline underline-offset-2">Reviews</a>.</p>
            </div>
          </div>
          ...
          <div className="border border-border rounded-lg p-4 space-y-2.5">
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <p className="text-xs font-semibold text-foreground">Facebook Reviews</p>
                  <p className="text-[11px] text-muted-foreground">Pull recommendations from your Facebook Business Page</p>
                </div>
              </div>
              <span className="inline-flex items-center gap-1 text-[11px] font-semibold px-2 py-0.5 rounded-full bg-secondary text-muted-foreground border border-border">
                <XCircle className="w-3 h-3" />Requires Upgrade
              </span>
            </div>
            <div className="text-[11px] text-muted-foreground space-y-1 pl-[2.75rem]">
              <p>Facebook reviews require the <span className="font-mono text-foreground/60">pages_read_user_content</span> permission on your Facebook Page access token.</p>
              <p className="text-amber-400/80">To enable: your Facebook app needs the <span className="font-mono">pages_read_user_content</span> permission approved by Meta. Once approved, reviews will appear automatically in <a href="/ops/reviews" className="underline underline-offset-2">Reviews</a>.</p>
            </div>
          </div>
